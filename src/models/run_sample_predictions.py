...
SAMPLE_CUSTOMERS = {
    ...
    "Long-tenure, two-year contract, autopay (expected low risk)": {
        "tenure": 65, "monthly_charges": 45.0, "total_charges": 2900.0,
    ...
    "Mid-tenure, one-year contract, mixed services (expected medium risk)": {
        "tenure": 20, "monthly_charges": 65.0, "total_charges": 1300.0,
        "contract": "One year", "payment_method": "Mailed check",
        "phone_service": "Yes", "internet_service": "DSL",
    ...
    "New customer, month-to-month, no internet (expected lower-than-typical-new risk)": {
        "tenure": 4, "monthly_charges": 22.0, "total_charges": 88.0,
        "contract": "Month-to-month", "payment_method": "Mailed check",
        "phone_service": "Yes", "internet_service": "No",
    ...
    "Established customer, month-to-month, high spend (expected medium-high risk)": {
        "tenure": 30, "monthly_charges": 100.0, "total_charges": 3000.0,
        "contract": "Month-to-month", "payment_method": "Electronic check",
        "phone_service": "Yes", "internet_service": "Fiber optic",
        "online_security": "No", "online_backup": "Yes", "device_protection": "Yes",
        "tech_support": "No", "streaming_tv": "Yes", "streaming_movies": "Yes",
    },
}
...
def run() -> None:
    ...
    for label, customer in SAMPLE_CUSTOMERS.items():
        ...
        for i, factor in enumerate(factors, start=1):
            print(f"        {i}. {factor['feature']} ({factor['direction']}, SHAP={factor['shap_value']:+.4f})")
        print()
